...
// сделаем файл Button.js. В нем опишем функцию для кнопки

// Уроки React JS с нуля / #7 – Работа со списками. Разработка проекта
// как выводить список пользаков на странице сайта
// уберем пробные компоненты button и image
// и почистим сайтик
// пойдем в css файл, добавим стилей
// создали файл Users.js
// туда добавим список пользаков, которых мы будем выводить на сайте
// добавили компонент Users в App.js

// Уроки React JS с нуля / #8 – Работа с формами в React JS!!!!!!!!!!!!!!!!!!!!!!!!!!
// чтобы пользаки отображались нужно юзать состояние, так как обычный массив не будет сохраняться
// уберем массив наш, и пропишем конструктор
// сделаем иконки
// скачаем библиотеку react-icons
// иконки можно гуглить и потом юзать и импортировать в проект
// например иконка: import { IoCloseCircleSharp } from 'react-icons/io5'
// после установки библиотеки нужно перезапустить сервер. 
// гуглить можно по словам react-icons. Там будет ссылка на гитхаб с иконками, и будут ссылки для импорта
// также пропишем стили для иконок

// теперь перейдем к формам!!!!!!!!!!!!!!!!
// формы создаем как отдельный компонент
// пропишем состояние за счет которого будем получать данные
// создадим несколько состояний в файле AddUser.js


// Уроки React JS с нуля / #9 – Удаление и редактирование записей!!!!!!!!!!!!!!!!!!!!!!!!!!!!
